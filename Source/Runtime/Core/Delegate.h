...
public:
	using DelegateFunction =
		typename _DelegatesInteral::MemberFunction<IsConst, T, RetVal, Args..., Args2...>::Type;
	...
	virtual const void* GetOwner() const override { return m_pObject; }
...
public:
	...
	bool HasHeapAllocation() const { return m_Size > MaxStackSize; }
...
public:
	...
	size_t GetSize() const { return m_Allocator.GetSize(); }
	...
	bool IsBound() const { return m_Allocator.HasAllocation(); }
...
private:
	...
	using ConstMemberFunction =
		typename _DelegatesInteral::MemberFunction<true, T, RetVal, Args..., Args2...>::Type;
	template <typename T, typename... Args2>
	using NonConstMemberFunction =
		typename _DelegatesInteral::MemberFunction<false, T, RetVal, Args..., Args2...>::Type;
...
public:
	...
	NO_DISCARD static Delegate CreateLambda(TLambda&& lambda, Args2... args)
	{
		...
		handler.Bind<LambdaDelegate<LambdaType, RetVal(Args...), Args2...>>(
...
private:
	...
	template <typename T, typename... Args2>
	using ConstMemberFunction =
		typename _DelegatesInteral::MemberFunction<true, T, void, Args..., Args2...>::Type;
	template <typename T, typename... Args2>
	using NonConstMemberFunction =
		typename _DelegatesInteral::MemberFunction<false, T, void, Args..., Args2...>::Type;
...
private:
	...
	// If this is true, the order of the array should not be changed otherwise this causes undefined
	// behaviour
